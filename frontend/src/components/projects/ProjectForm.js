  ...
  return (
    <div style={{ backgroundColor: "#f7efe5", minHeight: "100vh", padding: "2rem" }}>
      <div className="container d-flex justify-content-center">
        <div className="card shadow-sm p-4" style={{ maxWidth: "600px", width: "100%", backgroundColor: "#fffaf3" }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="row mb-3">
              <div className="col">
                <label htmlFor="start_date" className="form-label fw-semibold">Start Date</label>
                <input
                  type="date"
                  className="form-control"
                  id="start_date"
